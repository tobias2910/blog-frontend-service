  ...
  return createPortal(
    <div className="flex justify-center items-center fixed inset-0 h-screen w-screen backdrop-blur">
      <ClickAwayListener onOutsideClick={handleClose}>
        <div ref={innerRef} role="dialog" className="grid grid-rows-6 max-h-80 h-3/6 p-3 w-screen mx-4 lg:w-1/3 lg:h-1/3 bg-primary rounded border-2 border-secondary-2">
