  ...
  const handleOnChange = ((e: ChangeEvent) => {
    dispatcher({
      payload: {
        ...
        value: (e.target as HTMLInputElement).type === 'checkbox'
      ...
      <Card>
        <form className="px-1 md:px-8 flex flex-col">
          ...
          <Input
            ...
            showErrorMsg={!state.description.isValid && state.description.visited}
          ...
          >
            <span>
              I hereby confirm that I would like to be
              contacted via mail to discuss my project ideas.
            </span>
          </Checkbox>
