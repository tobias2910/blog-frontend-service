...
const SkillOverviewMobile: FC<SkillOverviewProps> = ({ skillData }) => {
  ...
  return (
    <div ref={skillTableRef} className="overflow-y-auto text-xs md:text-2xl flex w-full rounded-lg border-2 border-secondary-2 whitespace-nowrap shadow shadow-secondary-2">
      {
